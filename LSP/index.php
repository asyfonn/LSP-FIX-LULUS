...
<body>
    ...
    <div class="wisata1">
        ...
        <button type="button" class="btn btn-primary">IDR 30.000 / TIKET</button>
    </div>
    <div class="wisata2">
        <h1>MUSEUM PERJUANGAN</h1>
        <button type="button" class="btn btn-primary">IDR 20.000 / TIKET</button>
    </div>
    <div class="wisata3">
